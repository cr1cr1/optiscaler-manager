...
func TestCommandTable_AllStoresAllOS(t *testing.T) {
	...
	tests := []struct {
		...
		{"epic appname escaped", "linux", nil,
			launch.Target{Store: launch.StoreEpic, Name: "G", AppName: "Some Game/With?Chars"},
			"", []string{"xdg-open", "com.epicgames.launcher://apps/Some%20Game%2FWith%3FChars?action=launch&silent=true"}},
